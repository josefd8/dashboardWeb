...
class TbEditable extends CWidget {
	...
	public function registerAssets() {
		...
		if ($this->type == 'date' || $this->type == 'combodate') {
			 ...
			 */
			$widget = Yii::app ()->widgetFactory->createWidget ( $this->getOwner (), 'booster.widgets.TbDatePicker', array (
					'options' => isset ( $this->options ['datepicker'] ) ? $this->options ['datepicker'] : array () 
			) );
			 ...
			 */
			$widget = Yii::app ()->widgetFactory->createWidget ( $this->getOwner (), 'booster.widgets.TbDateTimePicker', array (
	 ...
	 * e.g.
	 * for 'select' to display text for id
	 *
	 * @param mixed $options        	
	 * @param mixed $type        	
	 */
