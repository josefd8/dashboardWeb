...
class TbInputHorizontal extends TbInput {
	...
	public function run() {
		echo CHtml::openTag ( 'div', array (
				'class' => 'control-group ' . $this->getContainerCssClass () 
		) );
		parent::run ();
	...
	protected function passfieldField() {
		...
		echo '<div class="controls">';
		echo $this->getPrepend ();
		$this->widget ( 'booster.widgets.TbPassfield', array (
				'model' => $this->model,
				'attribute' => $this->attribute,
	...
	protected function colorpickerField() {
		...
		echo '<div class="controls">';
		echo $this->getPrepend ();
		$this->widget ( 'booster.widgets.TbColorPicker', array (
				'model' => $this->model,
				'attribute' => $this->attribute,
				'format' => $format,
				'events' => isset ( $events ) ? $events : array (),
	...
	protected function markdownEditorJs() {
		...
		$this->widget ( 'booster.widgets.TbMarkdownEditorJs', array (
				'model' => $this->model,
				'attribute' => $this->attribute,
				'width' => isset ( $width ) ? $width : '100%',
				'height' => isset ( $height ) ? $height : '400px',
