...
class TbFormInputElement extends CFormElement {
	 ...
	 * This can be a widget class name, a path alias of a widget class name,
	...
	/**
	 * The options used when rendering label part.
	 * This property will be passed to the {@link CActiveForm::labelEx}
	...
	/**
	 * The options used when rendering the error part.
	...
	/**
	 * Whether to allow AJAX-based validation for this input.
	...
	/**
	 * Whether to allow client-side validation for this input.
	 * Note that in order to use
	...
	public function render() {
		...
		if (isset ( self::$inputTypes [$this->type] )) {
			...
			return $this->getParent ()->getActiveFormWidget ()->customFieldGroup ( array (
					array (
	 ...
	 * This method will check if the attribute associated with this
