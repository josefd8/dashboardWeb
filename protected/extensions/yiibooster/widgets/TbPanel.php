...
class TbPanel extends TbWidget {
	...
	/**
	 *
	 * @var string The class icon to display in the header title of the panel.
	...
	/**
	 *
	 * @var array panel HTML additional attributes
	 */
	public $htmlOptions = array ();
	
	/**
	 *
	 * @var array panel header HTML additional attributes
	 */
	public $headerHtmlOptions = array ();
	
	/**
	 *
	 * @var array panel content HTML additional attributes
	 */
