...
return array (
		'font-awesome' => array (
				...
				'css' => array (
						($this->minify || $this->enableCdn) ? 'css/font-awesome.min.css' : 'css/font-awesome.css' 
				) 
		),
		'bootstrap.js' => array (
				'baseUrl' => $this->enableCdn ? '//netdna.bootstrapcdn.com/bootstrap/3.1.1/' : $this->getAssetsUrl () . '/bootstrap/',
				'js' => array (
						$this->minify ? 'js/bootstrap.min.js' : 'js/bootstrap.js' 
				),
				'depends' => array (
						'jquery' 
				) 
		...
		'bootbox' => array (
				...
				'js' => array (
						$this->minify ? 'bootbox.min.js' : 'bootbox.js' 
				) 
		),
		'notify' => array (
				'baseUrl' => $this->getAssetsUrl () . '/notify/',
				'js' => array (
						$this->minify ? 'notify.min.js' : 'notify.js' 
				) 
		),
		...
		'ui-layout' => array (
				...
				'js' => array (
						$this->minify ? 'js/jquery.layout.min.js' : 'js/jquery.layout.js' 
				),
				'depends' => array (
						'jquery',
						'jquery.ui' 
		...
		'datetimepicker' => array (
				...
				'css' => array (
						$this->minify ? 'css/bootstrap-datetimepicker.css' : 'css/bootstrap-datetimepicker.css' 
				),
				'js' => array (
						$this->minify ? 'js/bootstrap-datetimepicker.min.js' : 'js/bootstrap-datetimepicker.js' 
				) 
		),
		'date' => array (
		...
		'colorpicker' => array (
				...
				'css' => array (
						$this->minify ? 'css/bootstrap-colorpicker.min.css' : 'css/bootstrap-colorpicker.css' 
				),
				'js' => array (
						$this->minify ? 'js/bootstrap-colorpicker.min.js' : 'js/bootstrap-colorpicker.js' 
				) 
		),
		'x-editable' => array (
				...
				'js' => array (
						$this->minify ? 'js/bootstrap-editable.min.js' : 'js/bootstrap-editable.js' 
				),
				'depends' => array (
						'jquery',
						'bootstrap.js',
		...
		'bootstrap.wizard' => array (
				...
				'js' => array (
						$this->minify ? 'jquery.bootstrap.wizard.min.js' : 'jquery.bootstrap.wizard.js' 
				) 
		),
		'ajax-cache' => array (
				'baseUrl' => $this->getAssetsUrl () . '/ajax-cache',
				'js' => array (
						'jquery.ajax.cache.js' 
				) 
		),
		'jqote2' => array (
		...
		'redactor' => array (
				...
				'js' => array (
						$this->minify ? 'redactor.min.js' : 'redactor.js' 
				),
				'css' => array (
						'redactor.css' 
				),
		...
		'passfield' => array (
				...
				'css' => array (
						$this->minify ? 'css/passfield.min.css' : 'css/passfield.min.css' 
				),
				'js' => array (
						$this->minify ? 'js/passfield.min.js' : 'js/passfield.min.js' 
				) 
		),
		'timepicker' => array (
				...
				'css' => array (
						$this->minify ? 'css/bootstrap-timepicker.min.css' : 'css/bootstrap-timepicker.css' 
				),
				'depends' => array (
						'bootstrap.js' 
				) 
		...
		'highcharts' => array (
				...
				'js' => array (
						$this->minify ? 'highcharts.js' : 'highcharts.src.js' 
				) 
		),
		'wysihtml5' => array (
				'depends' => array (
		...
		'switch' => array (
				...
				'css' => array (
						$this->minify ? 'css/bootstrap3/bootstrap-switch.min.css' : 'css/bootstrap3/bootstrap-switch.css' 
				),
				'js' => array (
						$this->minify ? 'js/bootstrap-switch.min.js' : 'js/bootstrap-switch.js' 
				) 
		),
		'typeahead' => array (
				'depends' => array (
				...
				'js' => array (
						$this->minify ? 'js/typeahead.bundle.min.js' : 'js/typeahead.bundle.js' 
				) 
		),
		'bootstrap-tags' => array (
				...
				'js' => array (
						$this->minify ? 'js/bootstrap-tags.min.js' : 'js/bootstrap-tags.js' 
				) 
		) 
);
