...
class ClientImpl implements IClient {
	...
	/**
	 * Our current received message.
	 * May be incomplete, will be completed
	 ...
	 * Asterisk may send responses without a
	 ...
	 *
	 * @param string $id
	 *        	The id returned by registerEventListener.
	 *        	
	 * @return void
	 */
	...
	protected function getMessages() {
		...
		while ( ($marker = strpos ( $this->_currentProcessingMessage, Message::EOM )) ) {
			...
			$this->_currentProcessingMessage = substr ( $this->_currentProcessingMessage, $marker + strlen ( Message::EOM ) );
			$msgs [] = $msg;
		}
		return $msgs;
	}
	 ...
	 * Also called from send(), you should call this in
	 ...
	 *
	 * @param PAMI\Message\IncomingMessage $message
	 *        	Message to dispatch.
	 *        	
	 * @return void
	 */
	...
	/**
	 * Returns a message (response) related to the given message.
	 * This uses
