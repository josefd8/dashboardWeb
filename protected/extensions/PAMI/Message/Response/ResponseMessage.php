...
class ResponseMessage extends IncomingMessage {
	...
	/**
	 * True if this response is complete.
	 * A response is considered complete
	 ...
	 * word 'start' in it.
	 * Another way is to have a Message key, like:
	 * Message: Result will follow
	 *
	 * @return boolean
	 */
	public function isList() {
		return stristr ( $this->getKey ( 'EventList' ), 'start' ) !== false || stristr ( $this->getMessage (), 'follow' ) !== false;
	}
	...
	/**
	 * Sets an action id.
	 * This should not be necessary, but asterisk sometimes
	 ...
	 *        	Literal message as received from ami.
	 *        	
	 * @return void
	 */
