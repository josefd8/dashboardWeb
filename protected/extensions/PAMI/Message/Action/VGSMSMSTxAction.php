...
class VGSMSMSTxAction extends ActionMessage {
	 ...
	 *
	 * @param string $to
	 *        	phone to send SMS to. Sign + and Countr code is needed in some countries.
	 *        	
	 * @return void
	 */
	 ...
	 *        	Content to use, default text/plain; charset=ASCII
	 *        	
	 * @return void
	 */
	 ...
	 *
	 * @param string $me_id
	 *        	Chip Id to use format meX , eg. me0 for VGSM 2 cards
	 *        	
	 * @return void
	 */
	...
	/**
	 * Sets $content - Message to send.
	 * Mandatory
	 *
	 * @param string $content
	 *        	Should be ASCII not utf8, no accents nada!.
	 *        	
	 * @return void
	 */
	...
	/**
	 * Sets X-SMS-Class key.
	 * Optional
	 *
	 * @param string $sms_class
	 *        	Class of SMS to send. Values are 0, 1. 0 is Flash message.
	 *        	
	 * @return void
	 */
	...
	/**
	 * Sets X-SMS-Concatenate-RefID .
	 * Optional. Should be set with
	...
	/**
	 * Sets X-SMS-Concatenate-Sequence-Number.
	 * Optional. Should be set with
	...
	/**
	 * Sets X-SMS-Concatenate-Total-Messages.
	 * Optional. Should be set with
